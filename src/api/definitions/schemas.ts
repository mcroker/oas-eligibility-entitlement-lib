...
const customAgeValidation = (value: any, helpers: any) => { // MCR_Temp_add anys
...
export const RequestSchema = Joi.object({
  ...
  yearsInCanadaSince18: Joi.number()
    ...
    .integer()
    .max(Joi.ref('age', { adjust: (age: number) => age - 18 }))
  ...
  everLivedSocialCountry: Joi.boolean()
    ...
    .custom((value: any, helpers: any) => {   // MCR_Helpers
  ...
  partnerYearsInCanadaSince18: Joi.number()
    ...
    .integer()
    .max(Joi.ref('partnerAge', { adjust: (age: number) => age - 18 }))
